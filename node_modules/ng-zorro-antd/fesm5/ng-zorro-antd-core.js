...
function () {
    ...
    return consoleCommonBehavior.apply(void 0, __spread([(/**
        ...
        function () {
            ...
            return console.error.apply(console, __spread([PREFIX, 'deprecated:'], arg, [stack]));
        })], args));
});
