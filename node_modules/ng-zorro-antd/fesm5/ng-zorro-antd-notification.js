...
import { warnDeprecation, trimComponentName, toCssPixel, NzConfigService, notificationMotion, NzSingletonService } from 'ng-zorro-antd/core';
...
var NzNotificationContainerComponent = /** @class */ (function (_super) {
    ...
    function (config) {
        /** @type {?} */
        var newConfig = (this.config = __assign({}, this.config, config, this.nzConfigService.getConfigForComponent(trimComponentName(this.constructor.name))));
        /** @type {?} */
